...
const EditPost = ({ data }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative  w-[500px] h-[520px] overflow-y-auto border-solid  border-[#f0f2f5] bg-white flex  rounded-b-[10px] pb-6">
        <div className=" w-full">
          ...
          <div className="px-4" style={{ textAlign: "left" }}>
            ...
            {lengthAI <= 0 && uploadedFiles.length <= 0 && (
              <label
                for="file"
                class="custum-file-upload w-[100%]  h-[280px]"
                {...getRootProps()}
              >
                <div className="icon">
                  <svg
                    ...
                    <div className="relative" key={index}>
                      {hiddenIds.includes(data.images[index].id) ? (
                        ...
                        <>
                          ...
                          <button
                            className="absolute top-[-10px] right-[-10px] p-2  rounded-full bg-gray-300 transition duration-300"
                            onClick={() => handleAddItem(data.images[index].id)}
                          >
                            <IoMdClose />
                          </button>
                        </>
